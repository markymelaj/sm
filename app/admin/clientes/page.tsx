      ...
      <section className="card p-5">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="muted mt-2 text-sm">Busca por nombre, RUT, parcela o número de rol. Aquí no aparecen usuarios internos.</p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link className="btn btn-secondary whitespace-nowrap" href="/admin/usuarios">Usuarios internos</Link>
            <Link className="btn btn-primary whitespace-nowrap" href="/admin/usuarios/alta">Alta de usuario</Link>
          </div>
        </div>
